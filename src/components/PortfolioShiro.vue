    ...
    <div id="content">
              ...
              <div class="col-lg-6">
                <div class="mt-5">
                  ...
                  <div class="mt-3" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <embed src="path/to/George-Alfeser-Resume.pdf" width="100%" height="600px" type="application/pdf">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container-narrow">
          ...
          <div class="text-center">
            <p class="mx-auto mb-3" style="max-width:600px">
              I can provide services for any kind of app or website. For real-time schemas, I can immediately maximize
              timely deliverables, ensuring seamless support specialist assistance throughout the process.</p>
          </div>
          <div class="row py-3">
            <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="100"><img class="mb-2"
                src="images/services/databasemanagement.jpg" width="96" height="96" alt="Database Management" />
              <div class="h5">Database Management</div>
            </div>
            <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="200"><img class="mb-2"
                src="images/services/api.jpg" width="96" height="96" alt="API" />
              <div class="h5">API Development</div>
            </div>
            <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="300"><img class="mb-2"
                src="images/services/techsup.jpg" width="96" height="96" alt="Technical Support" />
              <div class="h5">Technical Support</div>
            </div>
            <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="400"><img class="mb-2"
                src="images/services/helpdesksup.jpg" width="96" height="96" alt="Help Desk Support" />
              <div class="h5">Help Desk Support</div>
            </div>
          </div>
        </div>
      </div>
      <div class="section px-3 px-lg-4 pt-5" id="skills">
        <div class="container-narrow">
          ...
          <div class="text-center">
            <p class="mx-auto mb-3" style="max-width:600px">
              Skilled in adaptable backend development, quick at mastering new technologies, and passionate about
              delivering top-notch solutions in dynamic environments.</p>
          </div>
      ...
      <div class="section px-2 px-lg-4 pt-5" id="portfolio">
        <div class="container">
          <div class="text-center mb-5">
            <h2 class="marker marker-center">Clients Projects</h2>
          </div>
            ...
            <div class="grid-item">
              <a href="https://github.com/ShiroKuroGeo/uphols">
                <figure class="portfolio-item">
                  <img src="images/uphols.png" class="img-fluid border" data-bp="images/portfolio/1.jpg" />
                  <figcaption>
                    <h4 class="h5 mb-0">Capstone Project</h4>
                    <div>Upholstery</div>
                  </figcaption>
                </figure>
              </a>
          ...
          <div class="row">
              ...
              <div class="card mb-3" data-aos="fade-right" data-aos-delay="100">
                <div class="card-header px-3 py-2">
                  <div class="d-flex justify-content-between">
                    <div>
                      <h3 class="h5 mb-1">Full Stack Developer</h3>
                      <div class="text-muted text-small">Cordova Public College<small>( 2022 - 2024 )</small></div>
                    </div><img src="images/services/full-stack.svg" width="48" height="48" alt="full stack" />
                  </div>
                </div>
                <div class="card-body px-3 py-2">
                  <p>Pursuing my Information Technology ( IT ) College, I'm deeply intrigued by the intersection of
                    creativity and problem-solving that full-stack development offers</p>
                  <p>As a student, I'm constantly exploring new technologies and methodologies, eager to expand my
                    knowledge and tackle challenging projects.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card mb-3" data-aos="fade-right" data-aos-delay="100">
                <div class="card-header px-3 py-2">
                  <div class="d-flex justify-content-between">
                    <div>
                      <h3 class="h5 mb-1">Database Query Competition</h3>
                      <div class="text-muted text-small">Cordova Public College<small>( 2022 - 2023 )</small></div>
            ...
            <div class="col-md-6">
              <div class="card mb-3" data-aos="fade-right" data-aos-delay="100">
                ...
                <div class="card-body px-3 py-2">
                  <p>During the training period, I immersed myself in various tasks, including assembling and
        ...
        <div class="container-narrow">
          ...
          <div class="row">
            <div class="col-md-6 mb-5" data-aos="fade-right" data-aos-delay="100">
              <div class="d-flex ms-md-3"><span><i class="fas fa-2x fa-quote-left"></i></span><span class="m-2">Walter
                  displays exemplary professionalism and is able to take on challenges. He learns quickly and is an
            ...
            <div class="col-md-6 mb-5" data-aos="fade-right" data-aos-delay="200">
              <div class="d-flex ms-md-3"><span><i class="fas fa-2x fa-quote-left"></i></span><span class="m-2">Walter
                  is a great co-worker and problem solver. He is quick to extend his helping hand and makes a good team
                  player.</span></div>
              <div class="d-flex justify-content-end align-items-end">
                <div class="text-end me-2">
              ...
              <div class="bg-light my-2 p-3 pt-2">
                <form>
                  ...
                  <div class="form-group my-2">
                    ...
                    <textarea class="form-control" v-model="message" style="resize: none;" id="message" name="message"
      ...
      <footer class="pt-4 pb-4 text-center bg-light">
        <div class="container">
          ...
          <div class="text-small text-secondary">
            <div class="mb-1">&copy; Shiro Geo. All rights reserved.</div>
          </div>
        </div>
      </footer>
    </div>
